...
class ConvLSTMCell(nn.Module):
    ...
    def set_init_hidden_state(self, batch_size):
        self.init_hidden = (Variable(torch.zeros(batch_size, self.hidden_c, self.hidden_h, self.hidden_w)), 
            Variable(torch.zeros(batch_size, self.hidden_c, self.hidden_h, self.hidden_w)))
