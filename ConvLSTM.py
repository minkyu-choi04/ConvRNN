...
class ConvLSTMCell(nn.Module):
    def __init__(self, input_shape, hidden_c, kernel_shape, batch_size, isGPU):
        ...
        self.hidden_init = nn.Parameter(torch.zeros(batch_size, self.hidden_c, self.input_h, self.input_w))
        self.cell_init = nn.Parameter(torch.zeros(batch_size, self.hidden_c, self.input_h, self.input_w))
        self.init_hidden = (self.hidden_init, self.cell_init)
